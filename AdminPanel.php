    ...
    <div class="main-section">
        <div class="row">
            <div class="offset-lg-2 col-lg-8 section-part text-center" style="font-size: 20px;">
                ...
                <P>هل تريد إضافة موعد خروج ؟</P>
                <P>نحن نجعل الأمور سهلة, اضغط هنا</P>
                <button class="btn btn-danger" onclick="window.location.href = 'add_appointment.php'">اضغط هنا</button>
            </div>
        </div>
