    ...
    <div class="main-section">
        <div class="row">
            <div class="offset-lg-2 col-lg-8 section-part text-center" style="font-size: 20px;">
                <h1>مدرسة تعليم سياقة</h1>
                <P>هل تعتقد أن دراسة التؤوريا أمر صعب ؟</P>
                <P>نحن نجعل الأمور سهلة, اضغط وابدأ الامتحانات التجريبية</P>
                <button class="btn btn-danger" onclick="window.location.href = 'ListOfExams.php'">اضغط هنا</button>
            </div>
        </div>
